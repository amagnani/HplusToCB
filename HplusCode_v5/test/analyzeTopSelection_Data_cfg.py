...
process.source = cms.Source("PoolSource",
	...
	'file:/afs/cern.ch/work/a/amagnani/private/ANALYSIS_CODE/WORKDIR/CMSSW_5_3_23/src/TopQuarkAnalysis/TopPairBSM/test_data_reprocess/ttbsm_52x_data.root'
	...
	#'file:/afs/cern.ch/work/a/amagnani/private/ANALYSIS_CODE/TEST/CMSSW_5_3_23/src/MyJetProd/MyJetProducer/myOutputFile.root'
...
process.load("PhysicsTools.HplusCode_v5.topJetSelection_data_cff")
...
process.analyzeStart	= analyzeHplus_dataBkg.clone(sampleFlag=sample, stepFlag=flag1)
process.analyzeStep0	= analyzeHplus_dataBkg.clone(sampleFlag=sample, stepFlag=flag1)
process.analyzeStep1	= analyzeHplus_dataBkg.clone(sampleFlag=sample, stepFlag=flag1)
process.analyzeStep2	= analyzeHplus_dataBkg.clone(sampleFlag=sample, stepFlag=flag1)
process.analyzeStep3a   = analyzeHplus_dataBkg.clone(sampleFlag=sample, stepFlag=flag1)
process.analyzeStep3b   = analyzeHplus_dataBkg.clone(sampleFlag=sample, stepFlag=flag1)
process.analyzeStep4	= analyzeHplus_dataBkg.clone(sampleFlag=sample, stepFlag=flag1)
process.analyzeStep5a   = analyzeHplus_dataBkg.clone(sampleFlag=sample, stepFlag=flag1)
process.analyzeStep5b   = analyzeHplus_dataBkg.clone(sampleFlag=sample, stepFlag=flag1)
process.analyzeStep5c   = analyzeHplus_dataBkg.clone(sampleFlag=sample, stepFlag=flag1)
process.analyzeStep6	= analyzeHplus_dataBkg.clone(sampleFlag=sample, stepFlag=flag6)
process.analyzeStep7	= analyzeHplus_dataBkg.clone(sampleFlag=sample, stepFlag=flag1)
process.analyzeStep8a   = analyzeHplus_dataBkg.clone(sampleFlag=sample, stepFlag=flag1)
process.analyzeStep8b   = analyzeHplus_dataBkg.clone(sampleFlag=sample, stepFlag=flag8b)
process.analyzeStep9	= analyzeHplus_dataBkg.clone(sampleFlag=sample, stepFlag=flag9)
process.analyzeStep9b   = analyzeHplus_dataBkg.clone(sampleFlag=sample, stepFlag=flag9b)

process.makeTtSemiLepEventStep8a  = process.makeTtSemiLepEvent
