 ...
 * 
 *
 *\version  $Id: SINCROJetsProducer.h,v 1.2.12.3.4.1 2013/04/18 10:29:50 oiorio Exp $
 *
 *
*/
...
//#include "TopQuarkAnalysis/SINCRO/interface/EquationSolver.h"
...
//namespace pat {
  ...
  class SINCROJetsProducer : public edm::EDProducer {

    public:

      explicit SINCROJetsProducer(const edm::ParameterSet & iConfig);
      ~SINCROJetsProducer();
