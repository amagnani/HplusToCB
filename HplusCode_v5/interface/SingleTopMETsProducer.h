...
//#include "PhysicsTools//interface/EquationSolver.h"
...
//namespace pat {
  ...
  class SingleTopMETsProducer : public edm::EDProducer {
    ...
    edm::InputTag   metsSrc_,jetsSrc_;//  metsUnclUpSrc_, metsUnclDownSrc_, jetsSrc_,  electronsSrc_, muonsSrc_;
    ...
    bool isData_, isJERup_, isJERdown_, isJESup_, isJESdown_;
