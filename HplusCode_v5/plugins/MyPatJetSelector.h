#ifndef PhysicsTools_PatAlgos_MyPatJetSelector_h
#define PhysicsTools_PatAlgos_MyPatJetSelector_h
...
namespace pat {
  ...
  class MyPatJetSelector : public edm::EDFilter {
  public:


  MyPatJetSelector( edm::ParameterSet const & params ) : 
    edm::EDFilter( ),
