...
#		'/store/mc/Summer12/TTJets_TuneZ2star_8TeV-madgraph-tauola/AODSIM/PU_S7_START52_V5-v1/0000/FEBE99BB-3881-E111-B1F3-003048D42DC8.root'
 #       'file:/afs/cern.ch/work/a/amagnani/private/Step3_100_1_yn3.root'
#         'file:/afs/cern.ch/work/a/amagnani/private/Step3_99_1_cEU.root'
 #        'file:sincro.root'
#         'root://xrootd.unl.edu//store/mc/Summer12_DR53X/TTJets_MassiveBinDECAY_TuneZ2star_8TeV-madgraph-tauola/AODSIM/PU_S10_START53_V7A-v1/0000/FE4C2F81-D0E1-E111-9080-0030487E0A2D.root'
         'file:/afs/cern.ch/work/a/amagnani/private/ANALYSIS_CODE/WORKDIR/CMSSW_5_3_23/src/TopQuarkAnalysis/TopPairBSM/test_data_reprocess/0449388F-D2A7-E211-BEED-E0CB4E55363D.root'
		]    		
...
#	process.GlobalTag.globaltag = cms.string( 'GR_R_52_V7::All' )
	process.GlobalTag.globaltag = cms.string( 'FT53_V21A_AN6::All' )  #FT_53_V21_AN4::All'
else :
...
## The ecal Laser correction filter _______________________________________________||
...
#process.trigger=hltHighLevel.clone(HLTPaths =['HLT_Mu9'])
#process.trigger.TriggerResultsTag=cms.InputTag("TriggerResults","",options.triggerResults)
#triggerResultTagString="TriggerResults::"+TriggerProcessName
#print "Ciao:",process.trigger.TriggerResultsTagString

# switch on PAT trigger (da provare a scommentare)
...
#preso da PhysicsTools.PatAlgos.test.patTuple_PF2PATTypeIMET_cfg.py per provare ad aggiungere le correzioni di tipo 0
...
#process.selectedPatJetsPFlow.cut = cms.string("pt > 20 & abs(rapidity) < 2.4 ")
#process.selectedPatJetsPFlow.cut = cms.string("pt > 20 & abs(rapidity) < 2.4 & chargedEmEnergyFraction < 0.99 & neutralEmEnergyFraction < 0.99 & neutralHadronEnergyFraction < 0.99 & chargedHadronEnergyFraction > 0 & chargedMultiplicity > 0 & nConstituents >1 ")
process.selectedPatJetsPFlow.cut = cms.string("pt > 10 & abs(eta) < 2.5 & chargedEmEnergyFraction < 0.99 & neutralEmEnergyFraction < 0.99 & neutralHadronEnergyFraction < 0.99 & chargedHadronEnergyFraction > 0 & chargedMultiplicity > 0 & numberOfDaughters >1 ")
