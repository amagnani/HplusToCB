...
#ifndef analyze_MCsignal_kinfit_h
#define analyze_MCsignal_kinfit_h
...
//
  ...
  TH1F *Reco_hBTagWeight[15];
  TH1F *Reco_hnVertexNW[15];
  TH1F *Reco_hnVertex[15];
  TH1F *Reco_hMUeta[15];
  TH1F *Reco_hMUpt[15];
  TH1F *Reco_hMUrelIso[15];
  ...
  TH1F *KinFit_hprob_v1[15];
  TH1F *KinFit_hprob2_v1[15];
  TH1F *KinFit_hprob3_v1[15];
  TH1F *KinFit_hchi2_v1[15];
  TH1F *KinFit_hHmass_v1[15]; 
  TH1F *KinFit_hlepWmass_v1[15]; 
  TH1F *KinFit_hhadTopmass_v1[15];
  TH1F *KinFit_hlepTopmass_v1[15];

  TH1F *KinFit_hprob_v2[15];
  TH1F *KinFit_hprob2_v2[15];
  TH1F *KinFit_hprob3_v2[15];
  TH1F *KinFit_hchi2_v2[15];
  TH1F *KinFit_hHmass_v2[15]; 
  TH1F *KinFit_hlepWmass_v2[15]; 
  TH1F *KinFit_hhadTopmass_v2[15];
  TH1F *KinFit_hlepTopmass_v2[15];

  TH1F *KinFit_hprob_v3[15];
  TH1F *KinFit_hprob2_v3[15];
  TH1F *KinFit_hprob3_v3[15];
  TH1F *KinFit_hchi2_v3[15];
  TH1F *KinFit_hHmass_v3[15]; 
  TH1F *KinFit_hlepWmass_v3[15]; 
  TH1F *KinFit_hhadTopmass_v3[15];
  TH1F *KinFit_hlepTopmass_v3[15];

  TH1F *KinFit_hprob_v4[15];
  TH1F *KinFit_hprob2_v4[15];
  TH1F *KinFit_hprob3_v4[15];
  TH1F *KinFit_hchi2_v4[15];
  TH1F *KinFit_hHmass_v4[15]; 
  TH1F *KinFit_hlepWmass_v4[15]; 
  TH1F *KinFit_hhadTopmass_v4[15];
  TH1F *KinFit_hlepTopmass_v4[15];

  TH1F *KinFit_hprob_v5[15];
  TH1F *KinFit_hprob2_v5[15];
  TH1F *KinFit_hprob3_v5[15];
  TH1F *KinFit_hchi2_v5[15];
  TH1F *KinFit_hHmass_v5[15]; 
  TH1F *KinFit_hlepWmass_v5[15]; 
  TH1F *KinFit_hhadTopmass_v5[15];
  TH1F *KinFit_hlepTopmass_v5[15];

  TH1F *KinFit_hnVertex[15];  //stesse indentiche distribuzioni di prima, ma solo per eventi che sopravvivono al fit cinematico
  TH1F *KinFit_hMUeta[15];
  TH1F *KinFit_hMUpt[15];
  TH1F *KinFit_hnJet[15];
  TH1F *KinFit_hJeta[15];
  TH1F *KinFit_hJpt[15];  
  TH1F *KinFit_hMET[15];
  //control plots per versione del fit suggerita da marcello
  TH1F *KinFit_hnVertex_v4[15];  //stesse indentiche distribuzioni di prima, ma solo per eventi che sopravvivono al fit cinematico
  TH1F *KinFit_hMUeta_v4[15];
  TH1F *KinFit_hMUpt_v4[15];
  TH1F *KinFit_hnJet_v4[15];
  TH1F *KinFit_hJeta_v4[15];
  TH1F *KinFit_hJpt_v4[15];  
  TH1F *KinFit_hMET_v4[15];
  
  //control plots per versione del fit suggerita da marcello
  TH1F *KinFit_hnVertex_v5[15];  //stesse indentiche distribuzioni di prima, ma solo per eventi che sopravvivono al fit cinematico
  TH1F *KinFit_hMUeta_v5[15];
  TH1F *KinFit_hMUpt_v5[15];
  TH1F *KinFit_hnJet_v5[15];
  TH1F *KinFit_hJeta_v5[15];
  TH1F *KinFit_hJpt_v5[15];  
  TH1F *KinFit_hMET_v5[15];



   analyze_MCsignal_kinfit(TTree *tree=0);
   virtual ~analyze_MCsignal_kinfit();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     Loop(TFile *fHistos,  TH2D *h2_EffMapB, TH2D * h2_EffMapC, TH2D *h2_EffMapUDSG, TH1F *TTmassup_weight, TH1F *TTmassdown_weight, TH1F *TTmatchup_weight , TH1F *TTmatchdown_weight,
...
#ifdef analyze_MCsignal_kinfit_cxx
analyze_MCsignal_kinfit::analyze_MCsignal_kinfit(TTree *tree) : fChain(0) 
{
...
analyze_MCsignal_kinfit::~analyze_MCsignal_kinfit()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t analyze_MCsignal_kinfit::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t analyze_MCsignal_kinfit::LoadTree(Long64_t entry)
{
...
void analyze_MCsignal_kinfit::Init(TTree *tree)
{
...
Bool_t analyze_MCsignal_kinfit::Notify()
{
...
void analyze_MCsignal_kinfit::Show(Long64_t entry)
{
...
Int_t analyze_MCsignal_kinfit::Cut(Long64_t entry)
{
...
#endif // #ifdef analyze_MCsignal_kinfit_cxx
