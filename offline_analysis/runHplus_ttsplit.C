...
//    cout<<" Numbers of events Step9 (3 bjet 2 medium + 1 loose): "<<nevent_Step9<<endl;  
 ...
 sprintf(ext9b, "9b");
       ...
       gROOT->ProcessLine(".L analyze_ttsplit.C");
 
//     //semmai sostituire con Step0
//        TTree *t4 = (TTree*) ch_analyzeStart;
//        analyze_ttsplit *t = new analyze_ttsplit(t4);
...
//        analyze_ttsplit *rr = new analyze_ttsplit(rr4);
...
//  
       gROOT->ProcessLine(".L analyze_ttsplit_kinfit.C");
   
   
      TTree *rr4 = (TTree*) ch_analyzeStep9b;
      analyze_ttsplit_kinfit *rrk = new analyze_ttsplit_kinfit(rr4);
