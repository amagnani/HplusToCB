...
#ifndef analyze_dataBkg_h
#define analyze_dataBkg_h
...
public :
  ...
  TH1F *Reco_hMET[7];
   ...
   analyze_dataBkg(TTree *tree=0);
   virtual ~analyze_dataBkg();
...
#ifdef analyze_dataBkg_cxx
analyze_dataBkg::analyze_dataBkg(TTree *tree) : fChain(0) 
{
...
analyze_dataBkg::~analyze_dataBkg()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t analyze_dataBkg::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t analyze_dataBkg::LoadTree(Long64_t entry)
{
...
void analyze_dataBkg::Init(TTree *tree)
{
...
void analyze_dataBkg::Show(Long64_t entry)
{
...
Int_t analyze_dataBkg::Cut(Long64_t entry)
{
...
#endif // #ifdef analyze_dataBkg_cxx
