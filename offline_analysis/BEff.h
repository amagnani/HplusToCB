...
// Wed Apr 22 15:22:50 2015 by ROOT version 5.32/00
// from TTree HplusRecoTree/HplusRecoTree
// found on file: analyzePatTopSelection.root
//////////////////////////////////////////////////////////
...
public :
  ...
  TH2D  *Uh2_BTaggingEff_Denom_b;
  TH2D  *Uh2_BTaggingEff_Denom_c;
  TH2D  *Uh2_BTaggingEff_Denom_udsg;
  TH2D  *Uh2_BTaggingEff_Num_b;
  TH2D  *Uh2_BTaggingEff_Num_c;
  TH2D  *Uh2_BTaggingEff_Num_udsg;
  
  TH1F	*hTopPtWeight;
  TH1F	*hTopPtWeight_up;
  TH1F	*hTopPtWeight_down;
  ...
  TH1F	*hGenTopPt;
   ...
   virtual void     Loop(TFile *fHistos,  char *ext, int flag, char *outputTag);
...
#ifdef BEff_cxx
BEff::BEff(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("analyzePatTopSelection.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("analyzePatTopSelection.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("analyzePatTopSelection.root:/BEff");
      dir->GetObject("HplusRecoTree",tree);
...
Int_t BEff::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t BEff::LoadTree(Long64_t entry)
{
