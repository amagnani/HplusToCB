...
// For the statistics box:
  ...
  tdrStyle->SetOptStat(110); // To display the mean and RMS:   SetOptStat("mr");
  tdrStyle->SetStatColor(kWhite);
  tdrStyle->SetStatFont(42);
  tdrStyle->SetStatFontSize(0.065);
  //tdrStyle->SetStatFontSize(0.065);
  tdrStyle->SetStatTextColor(1);
  tdrStyle->SetStatFormat("6.4g");
  tdrStyle->SetStatBorderSize(1);
  //tdrStyle->SetStatH(0.15);
...
// For the axis titles:
 ...
 // tdrStyle->SetTitleYSize(Float_t size = 0.02);
  tdrStyle->SetTitleXOffset(1.9);
  tdrStyle->SetTitleYOffset(1.9);
  //tdrStyle->SetTitleOffset(1.4); // Another way to set the Offset
...
// For the axis labels:
  ...
  tdrStyle->SetLabelSize(0.045, "XY");
