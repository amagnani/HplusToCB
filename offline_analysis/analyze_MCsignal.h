...
#ifndef analyze_MCsignal_h
#define analyze_MCsignal_h
...
public :
  ...
  TH1F *Reco_hnSimVertexNW[15];
  TH1F *Reco_hnSimVertex[15];
  TH1F *Reco_hMUeta[15];
  TH1F *Reco_hMUpt[15];
  ...
  TH1F *Reco_hMET[15];
   ...
   cout<<"branches"<<endl;
   analyze_MCsignal(TTree *tree=0);
   virtual ~analyze_MCsignal();
...
#ifdef analyze_MCsignal_cxx
analyze_MCsignal::analyze_MCsignal(TTree *tree) : fChain(0) 
{
...
analyze_MCsignal::~analyze_MCsignal()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t analyze_MCsignal::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t analyze_MCsignal::LoadTree(Long64_t entry)
{
...
void analyze_MCsignal::Init(TTree *tree)
{
...
Bool_t analyze_MCsignal::Notify()
{
...
void analyze_MCsignal::Show(Long64_t entry)
{
...
Int_t analyze_MCsignal::Cut(Long64_t entry)
{
...
#endif // #ifdef analyze_MCsignal_cxx
