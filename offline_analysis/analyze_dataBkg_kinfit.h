...
#ifndef analyze_dataBkg_kinfit_h
#define analyze_dataBkg_kinfit_h
...
public :
   ...
   //HISTOGRAMS
  TH1F *Reco_hBTagWeight[7];
  TH1F *Reco_hnVertexNW[7];
  TH1F *Reco_hnVertex[7];
  TH1F *Reco_hnSimVertexNW[7];
  TH1F *Reco_hnSimVertex[7];
  TH1F *Reco_hMUeta[7];
  TH1F *Reco_hMUpt[7];
  TH1F *Reco_hMUrelIso[7];
  ...
  TH1F *KinFit_hprob_v1[7];
  TH1F *KinFit_hprob2_v1[7];
  TH1F *KinFit_hprob3_v1[7];
  TH1F *KinFit_hchi2_v1[7];
  TH1F *KinFit_hHmass_v1[7]; 
  TH1F *KinFit_hlepWmass_v1[7]; 
  TH1F *KinFit_hhadTopmass_v1[7];
  TH1F *KinFit_hlepTopmass_v1[7];

  TH1F *KinFit_hprob_v2[7];
  TH1F *KinFit_hprob2_v2[7];
  TH1F *KinFit_hprob3_v2[7];
  TH1F *KinFit_hchi2_v2[7];
  TH1F *KinFit_hHmass_v2[7]; 
  TH1F *KinFit_hlepWmass_v2[7]; 
  TH1F *KinFit_hhadTopmass_v2[7];
  TH1F *KinFit_hlepTopmass_v2[7];

  TH1F *KinFit_hprob_v3[7];
  TH1F *KinFit_hprob2_v3[7];
  TH1F *KinFit_hprob3_v3[7];
  TH1F *KinFit_hchi2_v3[7];
  TH1F *KinFit_hHmass_v3[7]; 
  TH1F *KinFit_hlepWmass_v3[7]; 
  TH1F *KinFit_hhadTopmass_v3[7];
  TH1F *KinFit_hlepTopmass_v3[7];

  TH1F *KinFit_hprob_v4[7];
  TH1F *KinFit_hprob2_v4[7];
  TH1F *KinFit_hprob3_v4[7];
  TH1F *KinFit_hchi2_v4[7];
  TH1F *KinFit_hHmass_v4[7]; 
  TH1F *KinFit_hlepWmass_v4[7]; 
  TH1F *KinFit_hhadTopmass_v4[7];
  TH1F *KinFit_hlepTopmass_v4[7];

  TH1F *KinFit_hprob_v5[7];
  TH1F *KinFit_hprob2_v5[7];
  TH1F *KinFit_hprob3_v5[7];
  TH1F *KinFit_hchi2_v5[7];
  TH1F *KinFit_hHmass_v5[7]; 
  TH1F *KinFit_hlepWmass_v5[7]; 
  TH1F *KinFit_hhadTopmass_v5[7];
  TH1F *KinFit_hlepTopmass_v5[7];

  TH1F *KinFit_hnVertex[7];  //stesse indentiche distribuzioni di prima, ma solo per eventi che sopravvivono al fit cinematico
  TH1F *KinFit_hMUeta[7];
  TH1F *KinFit_hMUpt[7];
  TH1F *KinFit_hnJet[7];
  TH1F *KinFit_hJeta[7];
  TH1F *KinFit_hJpt[7];  
  ...
  TH1F *KinFit_hnVertex_v4[7];  //stesse indentiche distribuzioni di prima, ma solo per eventi che sopravvivono al fit cinematico
  TH1F *KinFit_hMUeta_v4[7];
  TH1F *KinFit_hMUpt_v4[7];
  TH1F *KinFit_hnJet_v4[7];
  TH1F *KinFit_hJeta_v4[7];
  TH1F *KinFit_hJpt_v4[7];  
  TH1F *KinFit_hMET_v4[7];
  
  //control plots per versione del fit suggerita da marcello
  TH1F *KinFit_hnVertex_v5[7];  //stesse indentiche distribuzioni di prima, ma solo per eventi che sopravvivono al fit cinematico
  TH1F *KinFit_hMUeta_v5[7];
  TH1F *KinFit_hMUpt_v5[7];
  TH1F *KinFit_hnJet_v5[7];
  TH1F *KinFit_hJeta_v5[7];
  TH1F *KinFit_hJpt_v5[7];  
  TH1F *KinFit_hMET_v5[7];


   analyze_dataBkg_kinfit(TTree *tree=0);
   virtual ~analyze_dataBkg_kinfit();
...
#ifdef analyze_dataBkg_kinfit_cxx
analyze_dataBkg_kinfit::analyze_dataBkg_kinfit(TTree *tree) : fChain(0) 
{
...
analyze_dataBkg_kinfit::~analyze_dataBkg_kinfit()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t analyze_dataBkg_kinfit::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t analyze_dataBkg_kinfit::LoadTree(Long64_t entry)
{
...
void analyze_dataBkg_kinfit::Init(TTree *tree)
{
...
Bool_t analyze_dataBkg_kinfit::Notify()
{
...
void analyze_dataBkg_kinfit::Show(Long64_t entry)
{
...
Int_t analyze_dataBkg_kinfit::Cut(Long64_t entry)
{
...
#endif // #ifdef analyze_dataBkg_kinfit_cxx
