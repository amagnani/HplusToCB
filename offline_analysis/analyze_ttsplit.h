...
#ifndef analyze_ttsplit_h
#define analyze_ttsplit_h
...
public :
  ...
  TH1F *Reco_hMET[9][5];
   ...
   analyze_ttsplit(TTree *tree=0);
   virtual ~analyze_ttsplit();
...
#ifdef analyze_ttsplit_cxx
analyze_ttsplit::analyze_ttsplit(TTree *tree) : fChain(0) 
{
...
analyze_ttsplit::~analyze_ttsplit()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t analyze_ttsplit::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t analyze_ttsplit::LoadTree(Long64_t entry)
{
...
void analyze_ttsplit::Init(TTree *tree)
{
...
void analyze_ttsplit::Show(Long64_t entry)
{
...
Int_t analyze_ttsplit::Cut(Long64_t entry)
{
...
#endif // #ifdef analyze_ttsplit_cxx
